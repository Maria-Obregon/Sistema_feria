...
<head>
    <meta charset="UTF-8">
    <title>Certificado de participación - Colaborador</title>
    <style>
        @page {
            margin: 1.5cm;
        }
...
@php
    ...
    $etapa = $mapEtapa[$tipoFeria] ?? 'Institucional / Circuital / Regional';
...
<div class="marco">
    ...
    <div class="logo-esquina">
        <img src="{{ public_path('img/cert_colaborador_icon.png') }}" alt="Ícono colaborador" height="110">
    </div>
    ...
    <div class="parrafo">
        ...
        <span style="font-weight:bold;">Organización</span>
