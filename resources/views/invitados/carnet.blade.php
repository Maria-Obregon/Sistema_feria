...
<head>
    <meta charset="UTF-8">
    <title>Carnet de invitado</title>
    <style>
        @page {
            margin: 0;
        }
...
<body>
    <div class="contenedor">
                ...
                <tr>
                    ...
                    <td style="width: 60%;">
                        ...
                        <div class="caja-circuito">
                            Circuito {{ $invitado->feria->circuito->nombre ?? '____' }}
                        </div>
                    </td>
        ...
        {{-- ===== Zona central: tipo e invitado ===== --}}
        <div class="zona-central">
            <div class="tipo-invitacion">
                {{ $invitado->tipo_invitacion === 'dedicado' ? 'Dedicado.' : 'Invitado especial.' }}
            </div>

            <div class="caja-nombre">
                <div class="caja-nombre-inner">
                    {{ strtoupper($invitado->nombre) }}
                </div>
            </div>
        </div>
